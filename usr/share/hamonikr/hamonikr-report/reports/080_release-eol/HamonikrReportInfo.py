...
class Report(InfoReport):
    ...
    def is_pertinent(self):
        ...
        if self.days_before_eol < 90:
            if self.days_before_eol > 0:
                self.title = _("Your version of HamoniKR OS will soon reach End-Of-Life (EOL)")
                ...
                self.title = _("Your version of HamoniKR OS is no longer supported")
    ...
    def get_descriptions(self):
        ...
        descriptions.append(_("Visit %s to find information about newer releases.") % "<a href='https://hamonikr.org'>https://hamonikr.org</a>")
        return descriptions
